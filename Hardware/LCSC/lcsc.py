...
import subprocess
import sys
#python3 lcsc.py lcsc.txt --python python3
...
def main(argv=None):
    ...
    parser.add_argument("input_file", nargs="?", default="/Users/Thenewtechguy/Desktop/BeepBoop/Hardware", help="Path to file with one LCSC ID per line")
